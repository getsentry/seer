...
class TestNamespaceManager(unittest.TestCase):
    ...
    def test_integrity_check_success(self):
        ...
        self.assertTrue(namespace.verify_file_integrity(set(["path1", "path2"])))
    ...
    def test_integrity_check_fail_missing_file(self):
        ...
        self.assertFalse(namespace.verify_file_integrity(set(["path1", "path2"])))
    ...
    def test_integrity_check_fail_extra_file(self):
        ...
        self.assertFalse(namespace.verify_file_integrity(set(["path2"])))
