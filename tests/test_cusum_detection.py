...
class TestCusumDetector(unittest.TestCase):
    ...
    def test_get_changepoint(self):
        change_point = self.cusum_detector._get_change_point(
            np.asarray(self.data["y"]), 10, None, "increase"
        )
    ...
    def test_detector(self):
        ...
        actual_value = {
            "start_time": 1682308800,
            "end_time": 1682308800,
            "confidence": 1.0,
            "direction": "increase",
            "delta": 306.6691358024691,
            "regression_detected": True,
            "stable_changepoint": True,
            "mu0": 618.9666666666667,
            "mu1": 925.6358024691358,
            "llr": 153.06251960483866,
            "llr_int": np.inf,
            "p_value": 0.0,
            "p_value_int": np.nan,
        }
        ...
        expected_value = {
            "start_time": changepoint.start_time,
            "end_time": changepoint.end_time,
            "confidence": changepoint.confidence,
            "direction": changepoint.direction,
            "delta": changepoint.delta,
            "regression_detected": changepoint.regression_detected,
            "stable_changepoint": changepoint.stable_changepoint,
            "mu0": changepoint.mu0,
            "mu1": changepoint.mu1,
            "llr": changepoint.llr,
            "llr_int": changepoint.llr_int,
            "p_value": changepoint.p_value,
            "p_value_int": changepoint.p_value_int,
        }
