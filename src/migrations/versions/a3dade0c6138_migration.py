...
def upgrade():
    ...
    op.create_table('review_comments_embedding',
    ...
    with op.batch_alter_table('review_comments_embedding', schema=None) as batch_op:
        batch_op.create_index('ix_review_comments_embedding_hnsw', ['embedding'], unique=False, postgresql_using='hnsw', postgresql_with={'m': 16, 'ef_construction': 200}, postgresql_ops={'embedding': 'vector_cosine_ops'})
...
def downgrade():
    ...
    with op.batch_alter_table('review_comments_embedding', schema=None) as batch_op:
        ...
        batch_op.drop_index('ix_review_comments_embedding_hnsw', postgresql_using='hnsw', postgresql_with={'m': 16, 'ef_construction': 200}, postgresql_ops={'embedding': 'vector_cosine_ops'})
