...
def get_cache_prompt(fields: list[str], values: list[str]) -> str:

    # field_defintions = get_formatted_available_blocks(fields)
    field_definitions = ""
    ...
    prompt = textwrap.dedent(
        ...
        **Complex Query with Parentheses to Group Conditions**:
        ...
        When visualizing multiple aggregates or when grouping by a field, you should select an area or line chart since it is easier to compare the different aggregates and/or groups.
        If you are visualizing a single aggregate or field, you shouldselect a bar chart.
