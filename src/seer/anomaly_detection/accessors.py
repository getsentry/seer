...
class DbAlertDataAccessor(AlertDataAccessor):
    def _validate_id_or_source(
        ...
        if external_alert_id is None and (
            external_alert_source_id is None or external_alert_source_type is None
        ):
            raise ClientError(
    ...
    def _get_alert_or_raise(
        ...
        alert_info = self._get_alert_or_none(
    ...
    def _hydrate_alert(
        ...
        return DynamicAlert(
            ...
            external_alert_source_id=db_alert.external_alert_source_id,
            external_alert_source_type=db_alert.external_alert_source_type,
    ...
    def save_alert(
        ...
        with Session() as session:
            existing = self._get_alert_or_none(
                session,
                external_alert_id,
                external_alert_source_id,
                external_alert_source_type,
            ...
            if existing is not None:
                ...
                if external_alert_source_id is None:
                    external_alert_source_id = existing.external_alert_source_id
                if external_alert_source_type is None:
    ...
    def save_timepoint(
        ...
        with Session() as session:
            existing = self._get_alert_or_raise(
                session,
                external_alert_id,
                external_alert_source_id,
                external_alert_source_type,
    ...
    def queue_data_purge_flag(
        ...
        with Session() as session:
            dynamic_alert = self._get_alert_or_raise(
                session,
                external_alert_id,
                external_alert_source_id,
                external_alert_source_type,
