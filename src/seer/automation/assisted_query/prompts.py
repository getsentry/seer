...
def get_final_query_prompt(
    ...
    return f"""
        ...
        4. Explain succinctly why you generated this query. If you think that you did not have enough information or did not know how to properly construct the overall query, please explain what additional information and context you would have needed to successfuly create it.
