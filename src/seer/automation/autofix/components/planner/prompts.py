...
class PlanningPrompts:
    ...
    def format_system_msg():
        return textwrap.dedent(
            ...
            You have access to tools that allow you to search a codebase to find the relevant code snippets and view relevant files. You can use these tools as many times as you want to find the relevant code snippets. Every time you use a tool, you need to justify why extremely quickly to avoid being fired; to do so, just fill in this one sentencein the <log> tag and say nothing else: I'll do X because Y.
