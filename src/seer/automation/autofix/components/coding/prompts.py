...
class CodingPrompts:
    ...
    def format_fix_discovery_msg(
        ...
        return textwrap.dedent(
            ...
            # Your goal:
            Brainstorm and provide the most actionable and effective steps of code changes to fix the issue.
            ...
            - Focus on fixing the root cause of the issue, not just the symptoms.
            - EVERY TIME before you use a tool, think step-by-step each time before using the tools provided to you.
            - You also MUST think step-by-step before giving the final answer."""
        ).format(
            event_str=event,
