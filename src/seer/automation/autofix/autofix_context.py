...
class AutofixContext(PipelineContext):
    ...
    def query(
        ...
        with Session() as session:
            ...
            db_chunks_for_codebase = {db_chunk.id: index for index, db_chunk in enumerate(db_chunks)}
            populated_chunks.sort(key=lambda chunk: db_chunks_for_codebase[chunk.id])
