...
@sentry_sdk.trace
def run_summarize_issue_streaming(request: SummarizeIssueRequest) -> any:
    ...
    return summarize_issue_streaming(request)
...
def summarize_issue_streaming(
    ...
    # Stream the output and return the stream directly
